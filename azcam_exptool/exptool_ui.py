...
class Ui_ExposureTool(object):
    def setupUi(self, ExposureTool):
        ...
        self.widget.setGeometry(QRect(10, 400, 461, 21))
        self.horizontalLayout = QHBoxLayout(self.widget)
        self.horizontalLayout.setObjectName(u"horizontalLayout")
        self.horizontalLayout.setContentsMargins(0, 0, 0, 0)
        self.bar_label_1 = QLabel(self.widget)
        ...
        self.bar_label_2 = QLabel(self.widget)
        ...
        self.exposurestatus_label = QLabel(self.widget)
